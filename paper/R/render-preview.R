# Render a convenient HTML preview from the same executable manuscript.
main <- function(args = commandArgs(trailingOnly = TRUE)) {
  ...
  required <- c("rmarkdown", "knitr", "openssl")
  ...
  lib <- tempfile("gp3ml-paper-preview-lib-")
  ...
  output <- rmarkdown::render(
    ...
    output_file = "gp3ml-paper-preview.html",
    output_dir = out_dir,
