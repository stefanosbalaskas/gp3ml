...
- [Predefined recording-quality review
  status](https://stefanosbalaskas.github.io/gp3ml/articles/recording-quality-review.md):

  Governed grouped evaluation for an explicitly observed quality-control
  outcome.

- [Experimentally assigned condition
  discrimination](https://stefanosbalaskas.github.io/gp3ml/articles/assigned-condition-discrimination.md):

  A governed demonstration using an experimentally assigned label.

- [Explicitly observed behavioural
  endpoint](https://stefanosbalaskas.github.io/gp3ml/articles/observed-behavioral-endpoint.md):

  Prediction of a recorded non-sensitive response without latent-state
  interpretation.

### Generalization targets

- [Participant
  generalization](https://stefanosbalaskas.github.io/gp3ml/articles/participant-generalization.md):

  Leakage-resistant evaluation for new participants.

- [Stimulus
  generalization](https://stefanosbalaskas.github.io/gp3ml/articles/stimulus-generalization.md):

  Leakage-resistant evaluation for new stimuli.

- [Simultaneous participant and stimulus
  generalization](https://stefanosbalaskas.github.io/gp3ml/articles/participant-stimulus-generalization.md):

  Crossed grouped folds with explicit excluded rows.

### Advanced validation and reporting

- [Contaminated feature manifests and leakage
  cases](https://stefanosbalaskas.github.io/gp3ml/articles/contaminated-manifest-leakage.md):

  Deliberate governance failures for validation and review.

- [Nested grouped
  resampling](https://stefanosbalaskas.github.io/gp3ml/articles/nested-grouped-resampling.md):

  Inner tuning isolated inside each outer analysis partition.

- [External validation and transportability
  reporting](https://stefanosbalaskas.github.io/gp3ml/articles/external-validation-reporting.md):
...
- [Ecosystem update — September
  2026](https://stefanosbalaskas.github.io/gp3ml/articles/ecosystem-update-2026-09.md):
