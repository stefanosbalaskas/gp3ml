...
required when the intended target is generalization to unseen
stimuli. Preprocessing and feature selection must be estimated
inside the relevant resampling folds.
...
Version `0.0.0.9000` is the initial governance-only bootstrap.
No model-training interface has been implemented.
