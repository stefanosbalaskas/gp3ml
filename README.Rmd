...
`gp3ml` is an R package under cautious development for
leakage-resistant and group-aware predictive validation using
...
requires generalization to new participants. Stimulus overlap is
treated as a failure when the declared target requires generalization
to unseen stimuli. Preprocessing and feature selection must be
estimated inside the relevant resampling folds.
...
No model-training interface, automated feature selection, tuning,
nested resampling, or preprocessing engine has been implemented.
